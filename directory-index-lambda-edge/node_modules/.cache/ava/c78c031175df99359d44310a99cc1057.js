...
(0, _ava.default)('Handles /', t => {
  ...
  const request = _prod.default.handler(event, null, callback);
...
(0, _ava.default)('Handles missing request objects', t => {
  ...
  const request2 = _prod.default.handler(event2, null, callback);
  ...
  const request3 = _prod.default.handler(event3, null, callback);

  t.deepEqual(request3, {});
});
//# sourceMappingURL=/Users/joost/Code/pennsieve/developer.pennsieve.io/directory-index-lambda-edge/node_modules/.cache/ava/c78c031175df99359d44310a99cc1057.js.map